...
public class CameraControl : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        //开始移动
        //如果XZ不相等，且都不为0 那么我们就要把他们的速度同步一下
        ...
        transform.position = new Vector3(
            Mathf.Clamp(transform.position.x, X_MIN, X_MAX), transform.position.y,
    ...
    public void FocusOn()
    {
        ...
        transform.position = new Vector3(hero.x, hero.y + 20, hero.z - 5);
    }
