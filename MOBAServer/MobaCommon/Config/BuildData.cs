...
namespace MobaCommon.Config
{
    ...
    public class BuildData
    {
        ...
        private static void createBuild(int typeId, int hp, int attack, int defense, double attackDistance, string name,
            bool agressire, bool rebirth, int rebirthTime)
        {
            BuildDataModel model = new BuildDataModel(typeId, hp, attack, defense, attackDistance, name,
                agressire, rebirth, rebirthTime);
    ...
    public class BuildDataModel
    {
        ...
        public BuildDataModel(int typeId, int hp, int attack, int defense, double attackDistance, string name,
            bool agressire, bool rebirth, int rebirthTime)
        {
            this.TypeId = typeId;
            this.Hp = hp;
